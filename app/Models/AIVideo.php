...
class AIVideo extends Model
{
    ...
    public function likes() { return $this->hasMany(FeedLikes::class, 'feed_id')->where('feed_type', 'ai_videos'); }
    public function views() { return $this->hasMany(FeedViews::class, 'feed_id')->where('feed_type', 'ai_videos'); }
