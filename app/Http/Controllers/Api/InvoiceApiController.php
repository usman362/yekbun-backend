...
class InvoiceApiController extends Controller
{
    ...
    /**
     * GET /api/invoices/{id}/download — server-rendered PDF (binary download).
     *
     * PUBLIC route (no token) so it opens directly in a browser / native downloader.
     * Matches by _id / invoice_id / order_id.
     */
