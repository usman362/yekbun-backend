    ...
    public function showRequest(string $userId)
    {
        ...
        return ResponseHelper::sendResponse([
            ...
            'kyc' => $kyc ? [
                ...
                'front_image'    => Helpers::storageUrl($kyc->document_front ?? $kyc->front_image ?? null),
                'back_image'     => Helpers::storageUrl($kyc->document_back ?? $kyc->back_image ?? null),
                'selfie_image'   => Helpers::storageUrl($kyc->selfie_with_id ?? $kyc->selfie_image ?? null),
