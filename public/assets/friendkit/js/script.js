...
document.addEventListener("DOMContentLoaded", () => {
  ...
  createButton.addEventListener("click", () => {
    ...
    document.getElementById('limit').value = 'Unlimited';
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  createButton.addEventListener("click", () => {
    ...
    const donation_amount_type = document.getElementById('donation_amount_type').value;
    ...
    document.getElementById('donation_duration_2').value = duration_date;
    document.getElementById('donation_amount_type_2').value = donation_amount_type;
    document.getElementById('donation_amount_2').value = donation_amount;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const mp3Input = document.getElementById("Mp3InputModal23");
    const fileInput = document.querySelector(".fileInputModal23");
    const deleteButtonMp3 = document.getElementById("deleteButtonMp3Modal23");
    const previewContainerMp3 = document.getElementById("previewContainerMp3Modal23");
    const Mp3upload = document.getElementById("Mp3uploadModal23");
    const playButton = document.getElementById("playModal23");
    const durationSpan = document.getElementById("DurationModal23");
    const playIconModal17 = document.querySelector(".overlay img[src='"+ playbtn +"']");
    const MAX_DURATION = 300; // Maximum duration in seconds
    const allowedTypes = ["audio/mpeg", "audio/wav"];
    let audioElement = null; // Variable to store the audio element
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    createButton.addEventListener("click", () => {
      ...
      document.getElementById('event_date_st').textContent = event_st_date+'-'+event_end_date;
      document.getElementById('event_st_time').textContent = '. Start: '+event_st_time+' .';
      document.getElementById('event_end_time').textContent = '. End: '+event_end_time+' .';
